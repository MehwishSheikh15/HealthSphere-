...
//             <Link href={`/auth/signup`}>Book Appointment</Link>
//           </Button>
//       </CardFooter>
//     </Card>
//   );
...
export default function DoctorBookButton({ doctorId }: Props) {
  const router = useRouter();
  const [isLoggedIn, setIsLoggedIn] = useState<boolean | null>(null);

  // Example: Check auth via localStorage or cookie or your auth provider
  useEffect(() => {
